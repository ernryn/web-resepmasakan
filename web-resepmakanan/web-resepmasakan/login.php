      ...
      <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top" data-navbar-on-scroll="data-navbar-on-scroll">
        ...
        src="image/logo.png" alt="logo" /><span class="text-1000 fs-3 fw-bold ms-2 text-gradient">cookIngl</span></a>
          ...
          <div class="collapse navbar-collapse border-top border-lg-0 my-2 mt-lg-0" id="navbarSupportedContent">
            ...
            <a href="landingpage.php" class="btn btn-white shadow-warning text-warning"><i class="fas fa-user me-2"></i>Back</a>
          </div>
        </div>
      </nav>
                ...
                <div class="card-body">
                  <div class="tab-content mt-3" id="nav-tabContent">
                    <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                      <form class="row gx-2 gy-2 align-items-center" action="login-action.php" method="POST">
                      <div class="form-floating">
                            ...
                            <label for="floatingPassword" name="password"></label>
                            </div>
                        <div class="d-grid gap-3 col-sm-auto">
                          <button class="btn btn-danger" type="submit">Sign In</button> <button  type="reset">Reset</button>
                        </div>
                      </form>
                    </div>
                  </div>
